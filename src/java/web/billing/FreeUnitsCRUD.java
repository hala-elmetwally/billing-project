...
public class FreeUnitsCRUD {
    ...
    static public int insertFreeUnit(int call_units_onnet,int call_units_crossnet,int sms_onnet,int sms_crossnet,int data_units,int customer_id) {
        int rows = 0;
        try {
            ConnectDataBase.pstat = ConnectDataBase.connection.prepareStatement("INSERT INTO free_units(call_units_onnet,call_units_crossnet,sms_onnet,sms_crossnet,data_units,customer_id)VALUES (?,?,?,?,?,?)");
            ...
            ConnectDataBase.pstat.setInt(6, customer_id);

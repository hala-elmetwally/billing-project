...
<body>
 ...
 <%
        ...
        if (flag.equals("admin")){    session.setAttribute("Name", username); response.sendRedirect("Admin_Page.jsp");    }
            ...
            id =SignInCheck.getCustomerID(username, passwrd);
            comp_Name =SignInCheck.getCustomerName(username, passwrd);
            session.setAttribute("Name", username);  response.sendRedirect("user_login.jsp?id="+id+"&name="+comp_Name);}

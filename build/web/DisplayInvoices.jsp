...
//                if (fileEntry.isDirectory()) {
                        ...
                        File customer_invoice = new File("F:\\mayada\\ITI\\Billing\\web\\BillingPortal\\web\\Invoices\\");
                        for (File fileEntry1 : customer_invoice.listFiles()) {
                            if ((fileEntry1.isDirectory())) { 
                             String path = fileEntry1.getName();%>
                                <input type="button" value="<%=fileEntry1.getName()%>" style="background-color:  greenyellow; display: block; color: black; width: 300px; cursor:pointer; margin-left: 570px;  margin-bottom: 20px;  " onclick="location.href = 'DisplayInvoiceAdmin.jsp?path=<%=path%>'">
<%
//                            }
//                        }
